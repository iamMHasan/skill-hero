...
const Register = () => {
    ...
    const { providerLogin,gitHubProvider,createUser,updateUserProfile } = useContext(AuthContext)
    ...
    const handleFormSubmit = e => {
        ...
        .then(result => {
            ...
            console.log(user);
            toast.success("successfully user created", {autoClose: 400})
        })
        .catch(e => console.log(e))
        // update profile
        handleUserProfileUpdate(displayName,photoURL)
    }
    // update user profile 
